...
<table ><tr>
	<td width="150">全局变量</td><td width="200" align="center"><code>g_</code></td>
	</tr>
	<tr>
	<td>常量</td><td align="center"><code>c_</code></td>
    	</tr>
	<tr>
	<td>类的成员变量</td><td align="center"><code>m_</code></td>
	</tr>
	<tr>
	<td>静态变量</td><td align="center"><code>s_</code>
	</td>
	</tr>
</table>
